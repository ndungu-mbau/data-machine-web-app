  ...
  return {
      ...
      for (var i = 1; i < arguments.length; i++) {
        ...
        for (var key in obj) {
          if (obj.hasOwnProperty(key)) {
            if (typeof obj[key] === 'object') out[key] = KUtil.deepExtend(out[key], obj[key]);
      ...
      if (el.classList) {
        ...
        for (var i = 0; i < classNames.length; i++) {
          el.className = el.className.replace(
            new RegExp('\\b' + KUtil.trim(classNames[i]) + '\\b', 'g'),
            '',
          );
        }
      }
    ...
    data: function(element) {
      ...
      return {
        ...
        has: function(name) {
          ...
          return KUtilElementDataStore[element.customDataTag] &&
            KUtilElementDataStore[element.customDataTag][name]
            ? true
            : false;
        },
    ...
    outerWidth: function(el, margin) {
      ...
      if (margin === true) {
        ...
        width +=
          parseFloat(KUtil.css(el, 'margin-left')) + parseFloat(KUtil.css(el, 'margin-right'));
    ...
    slide: function(el, dir, speed, callback, recalcMaxHeight) {
      if (
        !el ||
        (dir == 'up' && KUtil.visible(el) === false) ||
        (dir == 'down' && KUtil.visible(el) === true)
      ) {
        return;
      }
...
var KApp = (function() {
  ...
  return {
    ...
    progress: function(target, options) {
      ...
      var classes =
        'k-loader ' + 'k-loader--' + skin + ' k-loader--' + alignment + ' k-loader--' + size;
  ...
  $.fn[pluginName] = function(options) {
    ...
    var Plugin = {
                    ...
                    $(td)
                      ...
                      .html(
                        $('<a/>')
                          ...
                          .append(
                            $('<i/>').addClass(Plugin.getOption('layout.icons.rowDetail.collapse')),
                          ),
                      );
                  }
                }
        ...
        var pg = {
          ...
          populate: function() {
            ...
            pg.pager = $('<div/>').addClass(
              pfx + 'datatable__pager ' + pfx + 'datatable--paging-loaded clearfix',
            );
            // numbering links
            ...
            $('<li/>')
              .append(
                $('<a/>')
                  ...
                  .addClass(
                    pfx + 'datatable__pager-link ' + pfx + 'datatable__pager-link--more-prev',
                  )
            ...
            $('<li/>')
              .append(
                $('<a/>')
                  .attr('title', title.more)
                  .addClass(
                    pfx + 'datatable__pager-link ' + pfx + 'datatable__pager-link--more-next',
                  )
                  .html($('<i/>').addClass(icons.more))
                  .on('click', pg.gotoMorePage),
              )
            ...
            $(datatable).ready(function() {
              $('.selectpicker')
                ...
                .attr(
                  'title',
                  Plugin.getOption('translate.toolbar.pagination.items.default.select'),
                );
            });
      ...
      columnHide: function() {
        ...
        $.each(options.columns, function(i, column) {
          if (typeof column.responsive !== 'undefined') {
            ...
            var tds = $.grep($(datatable.table).find('.' + pfx + 'datatable__cell'), function(
              n,
              i,
            ) {
              ...
              $('<td/>')
                ...
                .append(
                  $('<a/>')
                    ...
                    .append(
                      '<i class="' + Plugin.getOption('layout.icons.rowDetail.collapse') + '"></i>',
                    ),
                ),
            );
      ...
      getExtraSpace: function(element) {
        var padding =
          parseInt($(element).css('paddingRight')) + parseInt($(element).css('paddingLeft'));
        var margin =
          parseInt($(element).css('marginRight')) + parseInt($(element).css('marginLeft'));
      ...
      setActive: function(cell) {
        if (typeof cell === 'string') {
          ...
          cell = $(datatable.tableBody).find(
            '.' + pfx + 'checkbox--single > [type="checkbox"][value="' + cell + '"]',
          );
        }
          ...
          if (Plugin.recentNode === Plugin.nodeCols) {
            ...
            if (Plugin.isLocked()) {
              ...
              if (scrollColumns) {
                ...
                $(Plugin.recentNode).closest('.' + pfx + 'datatable__lock--right').length
              ) {
  ...
  var Plugin = {
    ...
    build: function() {
      ...
      window.addEventListener('scroll', function() {
        ...
        if (
          (KUtil.isInResponsiveRange('tablet-and-mobile') &&
            the.options.classic &&
            the.options.classic.mobile) ||
          (KUtil.isInResponsiveRange('desktop') &&
            the.options.classic &&
...
var KMenu = function(elementId, options) {
  ...
  var Plugin = {
    ...
    build: function() {
      ...
      the.eventHandlers['event_1'] = KUtil.on(
        element,
        '.k-menu__toggle',
        'click',
      ...
      if (Plugin.getSubmenuMode() === 'dropdown' || Plugin.isConditionalSubmenuDropdown()) {
        ...
        the.eventHandlers['event_2'] = KUtil.on(
          element,
          '[data-kmenu-submenu-toggle="hover"]',
          'mouseover',
          Plugin.handleSubmenuDrodownHoverEnter,
        );
        the.eventHandlers['event_3'] = KUtil.on(
          element,
          '[data-kmenu-submenu-toggle="hover"]',
          'mouseout',
        ...
        the.eventHandlers['event_4'] = KUtil.on(
          element,
          '[data-kmenu-submenu-toggle="click"] > .k-menu__toggle, [data-kmenu-submenu-toggle="click"] > .k-menu__link .k-menu__toggle',
          'click',
          Plugin.handleSubmenuDropdownClick,
        );
        the.eventHandlers['event_5'] = KUtil.on(
          element,
          '[data-kmenu-submenu-toggle="tab"] > .k-menu__toggle, [data-kmenu-submenu-toggle="tab"] > .k-menu__link .k-menu__toggle',
          'click',
      ...
      // General link click
      the.eventHandlers['event_6'] = KUtil.on(
        element,
        '.k-menu__item:not(.k-menu__item--submenu) > .k-menu__link:not(.k-menu__toggle):not(.k-menu__link--toggle-skip)',
        'click',
    ...
    getSubmenuMode: function(el) {
      if (KUtil.isInResponsiveRange('desktop')) {
        ...
        KUtil.isInResponsiveRange('tablet') &&
        KUtil.isset(the.options.submenu, 'tablet')
      ) {
        return the.options.submenu.tablet;
      } else if (
        KUtil.isInResponsiveRange('mobile') &&
        KUtil.isset(the.options.submenu, 'mobile')
      ) {
    ...
    isConditionalSubmenuDropdown: function() {
      if (
        KUtil.isInResponsiveRange('desktop') &&
        KUtil.isset(the.options.submenu, 'desktop.state.body')
      ) {
        return true;
      } else {
        return false;
    ...
    handleSubmenuDropdownClose: function(e, el) {
      ...
      var shown = element.querySelectorAll(
        '.k-menu__item.k-menu__item--submenu.k-menu__item--hover:not(.k-menu__item--tabs)',
      );

      // check if currently clicked link's parent item ha
      if (
        shown.length > 0 &&
        KUtil.hasClass(el, 'k-menu__toggle') === false &&
        el.querySelectorAll('.k-menu__toggle').length === 0
      ) {
      ...
      if (li && submenu) {
        ...
        if (KUtil.hasClass(li, 'k-menu__item--open') === false) {
          ...
          if (the.options.accordion.expandAll === false) {
            ...
            var closables = KUtil.children(
              subnav,
              '.k-menu__item.k-menu__item--open.k-menu__item--submenu:not(.k-menu__item--here):not(.k-menu__item--open-always)',
            );
    ...
    scrollToItem: function(item) {
      ...
      if (
        ...
        element.getAttribute('data-kmenu-scroll') !== '1'
      ) {
    ...
    showSubmenuDropdown: function(item) {
      ...
      var list = element.querySelectorAll(
        '.k-menu__item--submenu.k-menu__item--hover, .k-menu__item--submenu.k-menu__item--active-tab',
      );
    ...
    createSubmenuDropdownClickDropoff: function(el) {
      var query;
      var zIndex =
        (query = KUtil.child(el, '.k-menu__submenu') ? KUtil.css(query, 'z-index') : 0) - 1;

      var dropoff = document.createElement(
        '<div class="k-menu__dropoff" style="background: transparent; position: fixed; top: 0; bottom: 0; left: 0; right: 0; z-index: ' +
          zIndex +
          '"></div>',
      );
    ...
    adjustSubmenuDropdownArrowPos: function(item) {
      ...
      if (arrow) {
        ...
        if (
          KUtil.hasClass(submenu, 'k-menu__submenu--classic') ||
          KUtil.hasClass(submenu, 'k-menu__submenu--fixed')
        ) {
          ...
          if (
            KUtil.hasClass(submenu, 'k-menu__submenu--center') ||
            KUtil.hasClass(submenu, 'k-menu__submenu--full')
          ) {
            pos =
              KUtil.offset(item).left -
              (KUtil.getViewPort().width - parseInt(KUtil.css(submenu, 'width'))) / 2;
...
document.addEventListener('click', function(e) {
  ...
  if (
    (query = body.querySelectorAll(
      '.k-menu__nav .k-menu__item.k-menu__item--submenu.k-menu__item--hover:not(.k-menu__item--tabs)[data-kmenu-submenu-toggle="click"]',
    ))
  ) {
        ...
        if (e.target !== element && element.contains(e.target) === false) {
          ...
          if (
            (items = element.querySelectorAll(
              '.k-menu__item--submenu.k-menu__item--hover:not(.k-menu__item--tabs)[data-kmenu-submenu-toggle="click"]',
            ))
          ) {
  ...
  var Plugin = {
    ...
    setupTooltips: function() {
      if (the.options.tooltips) {
        var collapsed =
          KUtil.hasClass(element, 'k-portlet--collapse') ||
          KUtil.hasClass(element, 'k-portlet--collapsed');
        ...
        if (remove) {
          var tip = new Tooltip(remove, {
            ...
            trigger: 'hover',
            template:
              '<div class="tooltip tooltip-portlet tooltip bs-tooltip-top" role="tooltip">\
...
var KLayout = (function() {
  ...
  var initAside = function() {
    ...
    var asideOffcanvasClass = KUtil.hasClass(aside, 'k-aside--offcanvas-default')
      ? 'k-aside--offcanvas-default'
      : 'k-aside';
    ...
    if (KUtil.hasClass(body, 'k-aside--fixed')) {
      ...
      KUtil.addEvent(aside, 'mouseleave', function(e) {
        ...
        outsideTm = setTimeout(function() {
          if (
            KUtil.hasClass(body, 'k-aside--minimize-hover') &&
            KUtil.isInResponsiveRange('desktop')
          ) {
  ...
  var initAsideMenu = function() {
    ...
    var menuDesktopMode =
      KUtil.attr(menu, 'data-kmenu-dropdown') === '1' ? 'dropdown' : 'accordion';
    ...
    if (KUtil.attr(menu, 'data-kmenu-scroll') === '1') {
      scroll = {
        height: function() {
          ...
          height =
            height -
            (parseInt(KUtil.css(menu, 'marginBottom')) + parseInt(KUtil.css(menu, 'marginTop')));
  ...
  var initAsideToggler = function() {
    ...
    asideToggler.on('beforeToggle', function(toggle) {
      var body = KUtil.get('body');
      if (
        KUtil.hasClass(body, 'k-aside--minimize') === false &&
        KUtil.hasClass(body, 'k-aside--minimize-hover')
      ) {
        KUtil.removeClass(body, 'k-aside--minimize-hover');
      }
  ...
  var initNavs = function() {
    $('#k_aside_secondary_nav a[data-toggle="tab"]').on('click', function(e) {
      if (
        ...
        $('body').hasClass('k-aside-secondary--expanded')
      ) {
