...
var KDashboard = (function() {
  ...
  var latestProductsMiniCharts = function() {
    KLib.initMiniChart(
      $('#k_widget_latest_products_chart_1'),
      [6, 12, 9, 18, 15, 9, 11, 8],
      KApp.getStateColor('info'),
      2,
      false,
      false,
    );
    KLib.initMiniChart(
      $('#k_widget_latest_products_chart_2'),
      [8, 6, 13, 16, 9, 6, 11, 14],
    ...
    KLib.initMiniChart(
      $('#k_widget_latest_products_chart_3'),
      [8, 6, 13, 16, 9, 6, 11, 14],
      KApp.getStateColor('warning'),
      2,
      false,
    ...
    KLib.initMiniChart(
      $('#k_widget_latest_products_chart_4'),
      [3, 9, 9, 18, 15, 9, 11, 8],
    ...
    KLib.initMiniChart(
      $('#k_widget_latest_products_chart_5'),
      [5, 7, 9, 18, 15, 9, 11, 8],
      KApp.getStateColor('brand'),
      2,
      false,
    ...
    KLib.initMiniChart(
      $('#k_widget_latest_products_chart_6'),
      [3, 9, 5, 18, 15, 7, 11, 6],
      KApp.getStateColor('danger'),
      2,
      false,
  ...
  var generalStatistics = function() {
    ...
    KLib.initMiniChart(
      $('#k_widget_general_statistics_chart_4'),
    ...
    gradient1.addColorStop(
      0,
      Chart.helpers
        .color(KApp.getStateColor('brand'))
        .alpha(0.3)
        .rgbString(),
    );
    gradient1.addColorStop(
    ...
    gradient2.addColorStop(
      0,
      Chart.helpers
        .color(KApp.getStateColor('danger'))
        .alpha(0.3)
        .rgbString(),
    );
    gradient2.addColorStop(
  ...
  var widgetSalesStatisticsChart = function() {
    ...
    var barChartData = {
      ...
      datasets: [
        {
          label: 'Sales',
          backgroundColor: color(KApp.getStateColor('brand'))
            .alpha(1)
            .rgbString(),
          borderWidth: 0,
        ...
        {
          label: 'Orders',
          backgroundColor: color(KApp.getBaseColor('shape', 1))
            .alpha(1)
            .rgbString(),
          borderWidth: 0,
    ...
    var datatable = $('#k_recent_orders').KDatatable({
      ...
      columns: [
        ...
        },
        {
          ...
          template: function(row) {
            return (
              '<span class="k-label-font-color-3 k-font-bold">' +
              row.first_name +
              ' ' +
              row.last_name +
              '</span>'
        ...
        },
        {
          ...
          template: function(row) {
            ...
            return (
              ...
              ' k-badge--dot k-badge--md"></span>&nbsp;&nbsp;<span class="k-label-font-color-2 k-font-bold">' +
